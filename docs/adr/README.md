...
| **[ADR-006](file:///c:/Users/Magnet%20Busdev-2/Documents/temp/zoo-monitor/docs/adr/ADR-006-nx-best-shot-ordering-and-inference-clock-track-lifetimes.md)** | **Nx Best Shot Emission Ordering & Inference-Clock Track Lifetimes** | `Accepted` | 2026-09-25 | Fixes intermittent Nx thumbnails: object metadata must precede Best Shots, delayed 3 inference passes, with all track lifetimes counted in inference passes rather than pushed frames. |
